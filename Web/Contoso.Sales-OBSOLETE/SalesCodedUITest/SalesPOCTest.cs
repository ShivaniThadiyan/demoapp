...
namespace SalesCodedUITest
{
    ...
    public class SalesPOCTest
    {
        ...
        [TestMethod]
        public void SalesPOCTestMethod()
        {

            //string AppURL = "http://salespocwebmanesh.azurewebsites.net/";
            ...
            this.UIMap.LoginMethod();
            this.UIMap.UpdateQuota();
            this.UIMap.Logout();
